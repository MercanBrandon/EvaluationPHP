...
class ContactType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
             ...
             *      expanded : affichage de plusieurs champs; par defaut : false
             *      multiple : affichage de plusieurs choix; par defaut: false
             *  combinaison possible :
             *      liste déroulante : expanded false / multiple false
             *      bouton radio : expanded true / multiple false
             *      case à cocher : expanded true / multiple true : obligatoire pour les many to many (base de donnée)
             */
